...
return [
    ...
    | la clase de validación. Algunas de estas reglas tienen varias versiones, como las reglas de tamaño.
    ...
    */
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto nos permite especificar rápidamente un mensaje personalizado para una regla dada.
    |
    */
    ...
    | con algo más legible como "Dirección de Correo Electrónico" en lugar de "email".
