...
@section('content')
        ...
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item text-primary" aria-current="page"><a
                        href="{{ route('en.category.show', $product->category->en_slug) }}">{{ $product->category->en_name }}</a>
                </li>
                <li class="breadcrumb-item text-primary" aria-current="page">{{ $product->en_name }}</li>
            </ol>
        </nav>
    </div>
    {{-- End Breadcump --}}
        ...
        <div class="card-wrapper">
            <div class="card mt-3">
                ...
                <div class="product-content">
                    <h1 class="product-title mb-3">{{ $product->en_name }}</h1>
                        ...
                        <div class="box-download text-end">
                            @foreach ($documents as $document)
                                <a href="{{ asset('uploads/documents/' . $document) }}" target="blank"
                                    class="btn btn-outline-danger">Technical Data Sheet <i class="fas fa-download"></i></a>
                            @endforeach
                        </div>
                    @endif
                </div>
    ...
    @if (Str::length($product->en_details) > 1)
        <div class="more-details mt-5">
            <div class="container">
                <div class="card" style="width: 100%;">
                    <div class="card-body">
                        <h5 class="card-title">More Detailed Description</h5>
        ...
        <div class="similar-products mt-5">
            <div class="container">
                <div class="card" style="width: 100%;border: none;">
                    <div class="card-body">
                        <h5 class="card-title text-gray">Similar Products</h5>
                        <div class="main-slide-items">
                            <div class="similar-products-slider">
                                @foreach ($similars as $item)
                                    <div>
                                        <a href="{{ route('en.product.details', $item->en_slug) }}">
                                            <div class="card product-item border-0 mb-4 mr-2" style="width: 95%;">
                                                ...
                                                <div class="card-body border-left border-right p-1">
                                                    <p>{{ $item->category->en_name }}</p>
                                                    <h6 class="text-truncate">{{ $item->en_name }}</h6>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
