    ...
    <div class="search-content p-5">
        <div class="container">
            ...
            <div class="info-result m-4 p-2">
                <h2 class="result-term best-black">Search results for: <span
                        class="term text-primary">{{ $term }}</span></h2>
                <h6 class="result-count best-black">Results: <span class="count text-primary">{{ $productCount }}</span></h6>
            </div>
            {{-- End Header --}}
                    ...
                    <div class="col-md-9">
                        @forelse ($products as $product)
                            <div class="result-item mb-2">
                                <a href="{{ route('en.product.details', $product->en_slug) }}" class="btn">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="img-box">
                                        ...
                                        <div class="col-md-9">
                                            <div class="description-box pt-3">
                                                <p class="category-name">{{ $product->category->en_name }}</p>
