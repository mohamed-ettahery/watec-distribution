...
<head>
    ...
    <title>
        @yield('title', 'Swimming Pools, Water Treatment, Pumping, Renewable Energy | Watec Distribution')
    </title>
    @yield('meta')
    <meta name="keywords"
        content="swimming pools, water treatment Morocco, pumping, water softeners, osmosis, water filters Morocco, sterilizers, water technologies" />
    ...
    <div class="container-fluid bg-white sticky-top p-3">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                <a href="{{ route('en.home') }}" class="d-block d-md-none">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <a href="{{ route('en.home') }}" class="navbar-brand d-none d-md-block">
                        <img src="{{ asset('assets/imgs/logo2.webp') }}" style="width: 230px;margin-top: -33px;"
                            alt="watec distribution logo">
                    </a>
                    <div class="navbar-nav mx-auto">
                        <a href="{{ route('en.home') }}"
                            class="nav-item nav-link {{ Request::is('/en') ? 'active' : '' }}"><span
                        ...
                        <a href="{{ route('en.about') }}"
                            class="nav-item nav-link {{ Request::is('en/about') ? 'active' : '' }}">@lang('messages.about')</a>
                        <a href="{{ route('en.services') }}"
                            class="nav-item nav-link {{ Request::is('en/services') ? 'active' : '' }}">@lang('messages.services')</a>
                        <div class="nav-item dropdown has-megamenu">
                            <a class="nav-link dropdown-toggle go-products-btn {{ Request::is('en/products') ? 'active' : '' }}"
                                href="{{ route('en.products.all') }}" data-bs-toggle="dropdown"> @lang('messages.products')
                            </a>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="col-megamenu">
                                                        <a class="title h4 mb-2 btn-cat-redirect-products"
                                                            href="{{ route('en.category.show', $main_cat->en_slug) }}"><i
                                                                class="fas fa-angle-double-right"></i>
                                                            {{ $main_cat->en_name }}</a>
                                                        {{-- <a class="title h4 mb-2 btn-cat-redirect-products"
                                                    href="{{ route('en.category.show', $main_cat) }}"><i
                                                        class="fas fa-angle-double-right"></i>
                                                    {{ $main_cat->en_name }}</a> --}}
                                                        <ul class="list-unstyled child-items px-3">
                                                            @foreach (\App\Http\Controllers\CategoryController::getChildsCategories($main_cat->id) as $cat)
                                                                @if ($cat->hasProducts())
                                                                    <li><a href="{{ route('en.category.show', $cat) }}"
                        ...
                        <a href="{{ route('en.newspapers') }}"
                            class="nav-item nav-link {{ Request::is('en/newspapers') ? 'active' : '' }}">@lang('messages.news')</a>
                        <!--<div class="nav-item dropdown">-->
                        <!--    <a href="#"-->
                        <!--        class="nav-link dropdown-toggle {{ Request::is('en/contact') ? 'active' : '' }}"-->
                        ...
                        <!--    </div>-->
                        <!--</div>-->
                        <a href="{{ route('en.contact') }}"
                            class="nav-item nav-link {{ Request::is('en/contact') ? 'active' : '' }}">@lang('messages.contact')</a>
                    </div>
                    <div class="ms-auto d-none d-lg-block">
                        ...
                        <div id="searchModal" class="modal-search-form">
                            <div class="modal-content-search-form text-end">
                                ...
                                <form action="{{ route('en.search') }}" class="search-form">
                                    <input type="text" class="form-control search-input"
                                        placeholder="Search for products ..." name="term"
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>We are delighted to have you as our visitor and would like to invite you to subscribe to our
                        newsletter.</p>
                    <form action="{{ route('en.newsletter.store') }}" method="POST">
                        @csrf
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-medium text-light" href="{{ route('en.home') }}">Watec Distribution</a>, All
                    rights reserved.
                </div>
            </div>
        </div>
