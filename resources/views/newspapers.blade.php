    ...
    <div class="newspapers container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s"
                ...
                <p class="fs-5 fw-medium text-primary">Nos journaux</p>
                <h3 class="display-5 mb-5">vous pouvez consulter les nouveautés dans nos journaux</h3>
            </div>
            <div class="row">
                            ...
                            <a href="{{ asset('uploads/newspapers/documents/' . $newspaper->document) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <p class="text-secondary">{!! $newspaper->description !!}</p>
                ...
                <div class="col-md-4 wow fadeInRight">
                    <h6 class="text-center">Nos derniers journaux</h6>
                    {{-- <ul class="list-group"> --}}
                    <ul>
                            ...
                            <li class="list-group-item">
                                <a href="{{ asset('uploads/newspapers/documents/' . $newspaper->document) }}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <h6 class="limit6string">{{ $newspaper->title }}</h->
                                                <p class="text-muted">{{ $newspaper->newspaper_date }}</p>
                                        </div>
                                    </div>
                                </a>
